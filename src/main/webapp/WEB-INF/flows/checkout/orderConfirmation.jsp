...
<jsp:userBean id="now" class="java.util.Date"/>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="well col-xs-10 col-sm-10 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    ...
                    <div class="row">
                        <table class="table table-hover">
                            ...
                            <c:forEach var="cartItem" items="${order.cart.cartItems}">
                                <tr>
                                    <td class="col-md-9"><em>${cartItem.product.productNames}</em></td>
                    ...
                    <input type="submit" value="Submit ORDER" class="btn btn-default" name="_eventId_OrderConfimred" />
